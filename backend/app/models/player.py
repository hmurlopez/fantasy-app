...
class PlayerStats(Base):
    ...
    second_yellow_cards = Column(Integer, default=0)
    red_cards = Column(Integer, default=0)
    own_goals = Column(Integer, default=0)
    big_chances_created = Column(Integer, default=0)
    balls_into_box = Column(Integer, default=0)
    penalties_won = Column(Integer, default=0)
    penalties_committed = Column(Integer, default=0)
    effective_clearances = Column(Integer, default=0)
    goal_attempts = Column(Integer, default=0)
    effective_dribbles = Column(Integer, default=0)
    recoveries = Column(Integer, default=0)
    lost_balls = Column(Integer, default=0)
    # Computed
